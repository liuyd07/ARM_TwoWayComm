...
* Return         : None
*******************************************************************************/
void USART_Init(USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct, USART_ClockInitTypeDef* USART_ClockInitStruct)
{
...
/*---------------------------- USART CR2 Configuration -----------------------*/
  ...
  tmpreg |= (u32)USART_InitStruct->USART_StopBits | USART_ClockInitStruct->USART_Clock |
            USART_ClockInitStruct->USART_CPOL | USART_ClockInitStruct->USART_CPHA |
...
* Return         : None
*******************************************************************************/
void USART_StructInit(USART_InitTypeDef* USART_InitStruct, USART_ClockInitTypeDef* USART_ClockInitStruct)
{
